...
const JumiaCard = () => {
  return (
    <div className='bg-[#fe9900] '>
    <div className="max-w-[95%] mx-auto p-8 bg-white rounded-lg shadow-lg ">
      <h1 className="text-[17px] font-bold text-black mb-4">
        Jumia Nigeria - Nigeria's No. 1 Shopping Destination
      </h1>
      <p className="text-[17px] font-bold text-black mb-4">
      ...
      <p className="mb-4  text-[13px]">
        <strong>What Payment Options are Available on Jumia?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>Can I Return the Items I Bought From Jumia?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>When is the Next Jumia Black Friday?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>Can I get Free Delivery on All my Orders?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>What Is the Jumia Customer Care Line?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>How Can I Become a Seller on Jumia?</strong><br />
      ...
      <p className="mb-4 text-[13px]">
        <strong>What Other Events are Celebrated in Jumia?</strong><br />
